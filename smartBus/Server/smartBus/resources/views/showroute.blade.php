                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="">
                                <a onclick="fnClickAddRow();" href="javascript:void(0);" class="btn btn-primary ">添加线路</a>
                            ...
                            <table class="table table-striped table-bordered table-hover " id="editable" >
                                ...
                                @foreach ($res as $tmp)
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$tmp->route_start_time}}</td>
                                        <td class="center">{{$tmp->route_end_time}}</td>
                                        <td class="center">{{$tmp->route_price}}</td>
                                        <td class="center">{{$tmp->route_company}}</td>
                                        <td class="center">{{$tmp->route_length}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
